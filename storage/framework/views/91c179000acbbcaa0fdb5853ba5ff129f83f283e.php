...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <button type="button" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right" id="return_sale" title="<?php echo app('translator')->getFromJson('lang_v1.sell_return'); ?>" data-toggle="popover" data-trigger="click" data-content='<div class="m-8"><input type="text" class="form-control" placeholder="<?php echo app('translator')->getFromJson("sale.invoice_no"); ?>" id="send_for_sell_return_invoice_no"></div><div class="w-100 text-center"><button type="button" class="btn btn-danger" id="send_for_sell_return"><?php echo app('translator')->getFromJson("lang_v1.send"); ?></button></div>' data-html="true" data-placement="bottom">
...
<?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/upos/UltimatePOS-CodeBase-V4.7.8/resources/views/layouts/partials/header-pos.blade.php ENDPATH**/ ?>