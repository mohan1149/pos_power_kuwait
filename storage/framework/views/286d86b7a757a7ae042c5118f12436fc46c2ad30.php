...
<section class="content">
    ...
    <?php if($type == 'customer'): ?>
        <div class="col-md-3">
            <div class="form-group">
                <label for="has_no_sell_from"><?php echo app('translator')->getFromJson('lang_v1.has_no_sell_from'); ?>:</label>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="cg_filter"><?php echo app('translator')->getFromJson('lang_v1.customer_group'); ?>:</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/upos/UltimatePOS-CodeBase-V4.7.8/resources/views/contact/index.blade.php ENDPATH**/ ?>