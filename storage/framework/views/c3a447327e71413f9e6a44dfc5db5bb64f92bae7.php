      ...
      <div class="row payment_row">
        ...
        <?php if(!empty($pos_settings['enable_cash_denomination_on']) && $pos_settings['enable_cash_denomination_on'] == 'all_screens'): ?>
            ...
            <div class="col-md-12 cash_denomination_div <?php if(!in_array($payment_line->method, $enable_cash_denomination_for_payment_methods)): ?> hide <?php endif; ?>">
                <hr>
                <strong><?php echo app('translator')->getFromJson( 'lang_v1.cash_denominations' ); ?></strong>
                  <?php if(!empty($pos_settings['cash_denominations'])): ?>
                    ...
                    <p class="cash_denomination_error error hide"><?php echo app('translator')->getFromJson('lang_v1.cash_denomination_error'); ?></p>
                  <?php else: ?>
...
</div><!-- /.modal-dialog --><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/upos/UltimatePOS-CodeBase-V4.7.8/resources/views/transaction_payment/payment_row.blade.php ENDPATH**/ ?>