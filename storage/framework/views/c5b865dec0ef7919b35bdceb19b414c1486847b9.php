            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="product_list_tab">
                        <?php if($is_admin): ?>
                            <a class="btn btn-success pull-right margin-left-10" href="<?php echo e(action('ProductController@downloadExcel'), false); ?>"><i class="fa fa-download"></i> <?php echo app('translator')->getFromJson('lang_v1.download_excel'); ?></a>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/upos/UltimatePOS-CodeBase-V4.7.8/resources/views/product/index.blade.php ENDPATH**/ ?>