...
<!-- Main Header -->
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <?php endif; ?>
        ...
        <?php if(!empty(session('previous_user_id')) && !empty(session('previous_username'))): ?>
            <a href="<?php echo e(route('sign-in-as-user', session('previous_user_id')), false); ?>" class="btn btn-flat btn-danger m-8 btn-sm mt-10"><i class="fas fa-undo"></i> <?php echo app('translator')->getFromJson('lang_v1.back_to_username', ['username' => session('previous_username')] ); ?></a>
        <?php endif; ?>
  ...
  </header><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/upos/UltimatePOS-CodeBase-V4.7.8/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>