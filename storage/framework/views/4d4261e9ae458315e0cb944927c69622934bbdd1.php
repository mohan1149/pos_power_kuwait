...
<?php endif; ?>
	...
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								...
								<tr>
									...
									<td><strong><?php echo app('translator')->getFromJson( 'lang_v1.total_amount_exc_tax' ); ?>: </strong> <span id="total_subtotal"><?php echo e(number_format($subtotal, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></span>
...
</div><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/cocoa/resources/views/opening_stock/form-part.blade.php ENDPATH**/ ?>