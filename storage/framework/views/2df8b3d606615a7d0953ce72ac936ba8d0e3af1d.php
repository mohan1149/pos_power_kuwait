...
<tr class="product_row" data-row_index="<?php echo e($row_count, false); ?>" <?php if(!empty($so_line)): ?> data-so_id="<?php echo e($so_line->transaction_id, false); ?>" <?php endif; ?>>
	...
	<td>
		...
		<?php if(!empty($product->second_unit)): ?>
            ...
            <?php echo app('translator')->getFromJson('lang_v1.quantity_in_second_unit', ['unit' => $product->second_unit]); ?>*:</span><br>
            <input type="text" 
...
</tr><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/upos/UltimatePOS-CodeBase-V4.7.8/resources/views/sale_pos/product_row.blade.php ENDPATH**/ ?>