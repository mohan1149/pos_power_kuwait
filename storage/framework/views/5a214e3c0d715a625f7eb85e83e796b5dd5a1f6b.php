        ...
        <tr>
            ...
            <td>
                ...
                <?php if(!empty($activity->getExtraProperty('is_automatic'))): ?>
                    <span class="label bg-gray"><?php echo app('translator')->getFromJson('lang_v1.automatic'); ?></span>
                <?php endif; ?>
            </td>
            <td>
                ...
                <?php if(!empty($activity->getExtraProperty('email'))): ?>
                    <b><?php echo app('translator')->getFromJson('business.email'); ?>: </b> <?php echo e($activity->getExtraProperty('email'), false); ?>

                <?php endif; ?>

                <?php if(!empty($activity->getExtraProperty('mobile'))): ?>
                    <b><?php echo app('translator')->getFromJson('business.mobile'); ?>: </b> <?php echo e($activity->getExtraProperty('mobile'), false); ?>
...
<?php endif; ?><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/upos/UltimatePOS-CodeBase-V4.7.8/resources/views/activity_log/activities.blade.php ENDPATH**/ ?>