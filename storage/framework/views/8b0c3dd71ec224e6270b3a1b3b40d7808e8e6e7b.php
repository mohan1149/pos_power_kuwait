			...
			<div class="modal-body">
				...
				<div class="row <?php if(!$is_rp_enabled): ?> hide <?php endif; ?>">
				    ...
				    <div class="col-md-6">
				    	...
				    	<h5><strong><?php echo app('translator')->getFromJson('lang_v1.redeemed_amount'); ?>:</strong> <span id="rp_redeemed_amount_text"><?php echo e(number_format($rp_redeemed_amount, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></span></h5>
				    </div>
				    </div>
				</div>
			</div>
...
</div><!-- /.modal --><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/upos/UltimatePOS-CodeBase-V4.7.8/resources/views/sale_pos/partials/edit_discount_modal.blade.php ENDPATH**/ ?>