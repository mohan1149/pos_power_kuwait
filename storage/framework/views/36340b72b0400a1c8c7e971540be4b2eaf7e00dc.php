                ...
                <?php if($key == 'new_sale' || $key == 'payment_reminder'): ?>
                    <div class="col-md-12 mt-15">
                        ...
                        <?php if($key == 'payment_reminder'): ?>
                            <p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.payment_reminder_help'); ?></p>

                        <?php elseif($key == 'new_sale'): ?>
                            <p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.new_sale_notification_help'); ?></p>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                </div>
...
</div><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/cocoa/resources/views/notification_template/partials/tabs.blade.php ENDPATH**/ ?>