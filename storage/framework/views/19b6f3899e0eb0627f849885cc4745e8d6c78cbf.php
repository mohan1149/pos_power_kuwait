        ...
        <tr <?php if(!empty($purchase_line->purchase_order_line) && !empty($common_settings['enable_purchase_order'])): ?> data-purchase_order_id="<?php echo e($purchase_line->purchase_order_line->transaction_id, false); ?>" <?php endif; ?>>
            ...
            <td>
                ...
                <?php if(!empty($purchase_line->product->second_unit)): ?>
                    ...
                    <?php echo app('translator')->getFromJson('lang_v1.quantity_in_second_unit', ['unit' => $purchase_line->product->second_unit->short_name]); ?>*:</span><br>
                    <input type="text" 
...
<input type="hidden" id="row_count" value="<?php echo e($row_count, false); ?>"><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/cocoa/resources/views/purchase/partials/edit_purchase_entry_row.blade.php ENDPATH**/ ?>