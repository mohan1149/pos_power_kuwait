				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<?php echo Form::date('shipping_custom_field_1', !empty($transaction->shipping_custom_field_1) ? $transaction->shipping_custom_field_1 : null, ['class' => 'form-control','placeholder' => $shipping_custom_label_1, 'required' => $is_shipping_custom_field_1_required]);; ?>
				...
				<?php endif; ?>
				    <div class="col-md-6">
				        <div class="form-group">
				            ...
				            <?php echo Form::text('shipping_address_modal',!empty($transaction->shipping_address) ? $transaction->shipping_address : '', ['class' => 'form-control','placeholder' => __('lang_v1.shipping_address') ,'rows' => '4']);; ?>
...
</div><!-- /.modal --><?php /**PATH /Users/mohanvelegacherla/projects/custom/laravel/cocoa/resources/views/sale_pos/partials/edit_shipping_modal.blade.php ENDPATH**/ ?>